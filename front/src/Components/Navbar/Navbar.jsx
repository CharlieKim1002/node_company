...
const Navbar = () => {
    // Moblie version에서 열림,닫힘 기능 동작하기위한 상태 func
    const [isOpen, setIsOpen] = useState(false);
    // 언어 기능 동작하기 위한 상태 func
        ...
        <nav className="fixed top-0 left-0 w-full bg-white text-black p-4 shadow-lg z-50">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <select 
                    ...
                    className='hidden lg:block px-3 py-3 py-1 ml-8 border rounded-md bg-white hover:border-blue-500 transition duration-300'
                >
